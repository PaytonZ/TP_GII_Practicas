...
public class MatrizCeldas extends JPanel implements	ActionListener {
	...
	public MatrizCeldas(NavigationModule rob)
	{
		robot=rob;
		col=5;
		fil=5;
	...
	private void inicializaMatrizCeldas() {
		...
		for (int i=0; i<11; i++)
		{
			for (int j=0; j<11; j++)
			{
				...
				matrizBotones[i][j].setName("botonM"+i+j);
	...
	/**
	 * This method capture the pulse in the button.
	 */
	
	@Override
	public void actionPerformed(ActionEvent arg0) {
		robot.botonPulsado(arg0);
