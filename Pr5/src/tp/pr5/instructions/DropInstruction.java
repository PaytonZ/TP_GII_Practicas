...
public class DropInstruction implements Instruction {
	...
	public void execute() throws InstructionExecutionException {
		...
		else 
		{
			if ( this.navegador.getCurrentPlace().getObj().buscador(this.item)==-1)
			{
				...
				robot.setdiceRobotGrafica("Great! I have dropped " + it.getId());
				robot.setdiceRobotConsola("Great! I have dropped " + it.getId());
	...
	public void unExecute() {
		...
		robot.setdiceRobotGrafica("WALL·E says: UnDropInstruction realized");		
